...
*(Due **Thursday**, October 28th @ 11:59 PM)*
...
We will generate many such mutants.  Your final score will be based on the number of mutants your tests identify, with 50% based on the proportion of mutants your tests identify.
...
***Note:*** To get full credit, you will need to test for more mutants, so it is important to test above and beyond those tests above.
...
Submit your work by uploading the following files to Gradescope for the Lab06 assignment. Your submission will be automatically graded and your score recorded.
